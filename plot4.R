...
# making plots as saving them as png file 
png("plot4.png", width=480, height=480)
par(mfrow = c(2,2))
plot(datetime, electricity_part$Global_active_power, type="l", xlab="", ylab="Global Active Power")

plot(datetime, electricity_part$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(datetime, electricity_part$Global_reactive_power, type="l", xlab="datime", ylab="Global Reactive Power")
dev.off()
